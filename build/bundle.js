...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Life = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameOfLifeLogic = __webpack_require__(162);
	...
	function setInitialState(state, incomingData) {
	  var width = incomingData.gridWidth;
	  var outerArray = [];

	  for (var i = 0; i < width; i++) {
	    var innerArray = [];
	    for (var j = 0; j < width; j++) {
	      innerArray.push({ index: [i, j],
	        alive: false });
	    }
	...
	function randomize(state, incomingData) {
	  var width = state.getIn(['gridState']).size;
	  var outerArray = [];

	  for (var i = 0; i < width; i++) {
	    var innerArray = [];
	    for (var j = 0; j < width; j++) {
	      var cellState = Math.random() > .5 ? true : false;
	      innerArray.push({ index: [i, j],
	        alive: cellState });
	    }
	    outerArray.push(innerArray);
	  ...
	  var nextState = state.updateIn(['gridState'], function () {
	    return Immutable.fromJS(outerArray);
	  });
	  nextState = nextState.updateIn(['tickCount'], function () {
	    return 0;
	  }); // Reset tickCount
	...
	function getGlider(state, incomingData) {
	  var gliderCells = [[2, 1], [3, 2], [3, 3], [2, 3], [1, 3]];
	  var nextState = state.getIn(['gridState']);

	  gliderCells.forEach(function (index) {
	    nextState = nextState.updateIn([index[0], index[1], 'alive'], function () {
	      return true;
	    });
	  });
	...
	function highlightCell(state, incomingData) {
	  var index = incomingData.index;
	  var nextState = state.updateIn(['gridState', index[0], index[1], 'alive'], function (value) {
	    return true;
	  });
	  nextState = nextState.updateIn(['tickCount'], function () {
	    return 0;
	...
	function pause(state, incomingData) {
	  return state.updateIn(['isPaused'], function () {
	    return true;
	  });
	}
	...
	function reducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'TICK':
	      return (0, _gameOfLifeLogic.tick)(state, action.data);
	    case 'PAUSE':
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getLiveNeighborCount(gridState) {
	  var _getIn$toJS = this.getIn(['index']).toJS();

	  var _getIn$toJS2 = _slicedToArray(_getIn$toJS, 2);

	  var x = _getIn$toJS2[0];
	  var y = _getIn$toJS2[1];

	  var directions = [[-1, 0], // West
	  [-1, 1], // Northwest
	  [0, 1], // North
	  [1, 1], // Northeast
	  [1, 0], // East
	  ...
	  directions.forEach(function (d) {
	    ...
	    var neighborOnGrid = neighborX > 0 && neighborY > 0 && neighborX < gridState.size && neighborY < gridState.size;
	...
	function updateCell(count) {
	  var currentlyAlive = this.getIn(['alive']);

	  return this.updateIn(['alive'], function () {
	    switch (true) {
	...
	function tick(state, incomingData) {
	  var gridState = state.getIn(['gridState']);

	  var nextGrid = gridState.map(function (row, i, gridContext) {
	    return row.map(function (cell, j, rowContext) {
	      var count = getLiveNeighborCount.call(cell, gridState);
	  ...
	  nextState = nextState.updateIn(['tickCount'], function (count) {
	    return count + 1;
	  });
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "gameOfLifeLogic.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LifeContainer = exports.Life = undefined;
	...
	var _LifeGrid = __webpack_require__(182);
	...
	var Life = exports.Life = function (_React$Component) {
	  ...
	  _createClass(Life, [{
	    key: 'onCellClick',
	    value: function onCellClick(index, currentlyLive) {
	      currentlyLive ? this.props.dispatch((0, _actions.unhighlight)(index)) : this.props.dispatch((0, _actions.highlight)(index));
	    }
	  }, {
	    key: 'onTickClick',
	    value: function onTickClick() {
	      this.props.dispatch((0, _actions.tick)());
	    }
	  }, {
	    key: 'onResetClick',
	    ...
	    value: function onRandomizeClick() {
	      this.props.dispatch((0, _actions.randomize)());
	    }
	  }, {
	    key: 'onGliderClick',
	    value: function onGliderClick() {
	      this.props.dispatch((0, _actions.setInitialState)());
	      this.props.dispatch((0, _actions.getGlider)());
	    }
	  }, {
	    key: 'onPauseClick',
	    value: function onPauseClick(isPaused) {
	      isPaused ? this.props.dispatch((0, _actions.unpause)()) : this.props.dispatch((0, _actions.pause)());
	    }
	  }, {
	    key: 'tickCycle',
	    ...
	    key: 'establishAnimationFrame',
	    value: function establishAnimationFrame() {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_LifeGrid.LifeGrid, {
	...
	var LifeContainer = exports.LifeContainer = (0, _reactRedux.connect)(mapStateToProps)(Life);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LifeGrid = exports.LifeGrid = function (_React$Component) {
	  _inherits(LifeGrid, _React$Component);

	  function LifeGrid() {
	    _classCallCheck(this, LifeGrid);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(LifeGrid).apply(this, arguments));
	  }

	  _createClass(LifeGrid, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var currentState = this.props.gridState.toJS();
	      ...
	      var table = _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'tbody',
	          null,
	          currentState.map(function (row, rowIndex) {
	            return _react2.default.createElement(
	              'tr',
	              { key: rowIndex },
	              row.map(function (cell, cellIndex) {
	                return _react2.default.createElement(_Cell.Cell, {
	                  ...
	                  onCellClick: _this2.props.onCellClick
	                });
	              })
	            );
	          })
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "LifeGrid.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = exports.Cell = function (_React$Component) {
	  ...
	  _createClass(Cell, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var cellClass = (0, _classnames2.default)({
	        'cell': true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TickButton = __webpack_require__(186);

	var _PauseButton = __webpack_require__(187);

	var _ResetButton = __webpack_require__(188);

	var _RandomizeButton = __webpack_require__(189);

	var _GliderButton = __webpack_require__(190);

	var _TickCounter = __webpack_require__(191);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_RandomizeButton.RandomizeButton, {
	            onRandomizeClick: this.props.onRandomizeClick
	          }),
	          _react2.default.createElement(_GliderButton.GliderButton, {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_TickButton.TickButton, {
	            onTickClick: this.props.onTickClick
	          }),
	          _react2.default.createElement(_PauseButton.PauseButton, {
	            isPaused: this.props.isPaused,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_TickCounter.TickCounter, {
	            tickCount: this.props.tickCount
	          })
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TickButton = exports.TickButton = function (_React$Component) {
	  _inherits(TickButton, _React$Component);

	  function TickButton() {
	    _classCallCheck(this, TickButton);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TickButton).apply(this, arguments));
	  }

	  _createClass(TickButton, [{
	    key: 'handleClick',
	    value: function handleClick() {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TickButton.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PauseButton = exports.PauseButton = function (_React$Component) {
	  _inherits(PauseButton, _React$Component);
	  ...
	  _createClass(PauseButton, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var buttonText = this.props.isPaused ? "Play" : "Pause";
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PauseButton.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RandomizeButton = undefined;
	...
	var RandomizeButton = exports.RandomizeButton = function (_React$Component) {
	  _inherits(RandomizeButton, _React$Component);

	  function RandomizeButton() {
	    _classCallCheck(this, RandomizeButton);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(RandomizeButton).apply(this, arguments));
	  }

	  _createClass(RandomizeButton, [{
	    key: 'handleClick',
	    value: function handleClick() {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "RandomizeButton.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.GliderButton = undefined;
	...
	var GliderButton = exports.GliderButton = function (_React$Component) {
	  _inherits(GliderButton, _React$Component);

	  function GliderButton() {
	    _classCallCheck(this, GliderButton);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GliderButton).apply(this, arguments));
	  }

	  _createClass(GliderButton, [{
	    key: 'handleClick',
	    value: function handleClick() {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "GliderButton.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TickCounter = exports.TickCounter = function (_React$Component) {
	  _inherits(TickCounter, _React$Component);

	  function TickCounter() {
	    _classCallCheck(this, TickCounter);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TickCounter).apply(this, arguments));
	  }

	  _createClass(TickCounter, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/danielweinstein/Documents/Recurse/react_experimentation/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TickCounter.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function unhighlight(cellIndex) {
	  return {
